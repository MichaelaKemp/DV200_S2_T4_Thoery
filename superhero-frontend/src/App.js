...
// Use CORS to allow cross-origin requests only from your frontend
app.use(cors({
  origin: 'https://nameless-temple-24409.herokuapp.com', // Allow requests from your frontend URL
...
const dbUrl = process.env.DATABASE_URL || 'mysql://pjhprxukssvt0z0s:wcdi1gggecx6lxny@k9xdebw4k3zynl4u.cbetxkdyhwsb.us-east-1.rds.amazonaws.com:3306/hemqi27lta38v17n';
